     ...
     const StatCard = ({statTitle, total, currentMonthCount, lastMonthCount}) => {
           ...
           const {trend, percentage} = calculateTrendPercentage(currentMonthCount, lastMonthCount)
            ...
            const isDecrement = trend === 'decrement'
                 ...
                 return (
                        <div className="bg-[#1F2225] h-40 border-[1.9px] border-[#4B4D4F] rounded-xl p-2 justify-cente gap-3">
                         <div className="flex flex-col gap-4">
                           <p className="font-semibold text-[1.5rem] font-sans text-white">{statTitle}</p>
                            ...
                            <div className="flex flex-col gap-2 items-center">
                               ...
                               <p className={cn('text-sm font-semibold font-sans', isDecrement ? 'text-destructive-100' : 'text-green-400')}>{Math.round(percentage)}%<span className="text-light-100"> vs last month</span></p>
                              </div>
